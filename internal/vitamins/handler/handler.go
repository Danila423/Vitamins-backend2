// Package handler wires vitamins HTTP endpoints to the service layer.
package handler
...
// ErrorResponse is the public JSON contract for all vitamins errors. The
// frontend relies on the `code` field to branch its error handling; avoid
// renaming fields without coordinating a migration.
...
// @Accept       json
// @Produce      json
// @Success      200 {array} service.CatalogItem
...
// @Accept       json
// @Produce      json
// @Param        request body service.CreateReminderRequest true "Данные напоминания"
// @Security     BearerAuth
// @Success      200 {object} service.ReminderResponse
...
func (h *Handler) CreateReminder(c *gin.Context) {
	var r service.CreateReminderRequest
...
// @Produce      json
// @Security     BearerAuth
// @Success      200 {array} service.ReminderResponse
// @Failure      401 {object} ErrorResponse
// @Failure      500 {object} ErrorResponse
...
// @Produce      json
// @Param        id path int true "ID напоминания"
// @Param        request body service.UpdateReminderRequest true "Данные для обновления"
// @Security     BearerAuth
// @Success      200 {object} service.ReminderResponse
// @Failure      400 {object} ErrorResponse
// @Failure      401 {object} ErrorResponse
...
func (h *Handler) UpdateReminder(c *gin.Context) {
	var r service.UpdateReminderRequest
	if err := c.ShouldBindJSON(&r); err != nil {
		send(c, 400, "BAD_REQUEST", "Неверный формат запроса")
		return
	}
...
func (h *Handler) handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTimes):
