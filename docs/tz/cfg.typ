#let cfg = (
    project: (
        code: "RU.17701729.12.20-01 ТЗ 01-1",
        name: [
    ...
    annotation: [
        ...
        Настоящее Техническое задание на разработку «Мобильного приложения для напоминаний о приеме витаминов» содержит следующие разделы: "Введение", "Основания для разработки", "Назначение разработки", "Требования к программе", "Требования к программной документации", "Технико-экономические показатели", "Стадии и этапы разработки", "Порядок контроля и приемки", приложения [7].
